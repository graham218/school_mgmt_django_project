...
class Students(models.Model):
    ...
    stud_gender=models.ForeignKey(Gender, on_delete=models.CASCADE, blank=True)
    ...
    date_of_graduation=models.DateTimeField(blank=True)
    programme=models.ForeignKey(Programmes, on_delete=models.CASCADE, max_length=255, blank=True)
    stage=models.ForeignKey(Stages, on_delete=models.CASCADE, blank=True)
    ...
    total_fees_billed=models.DecimalField(max_digits=10, decimal_places=2, blank=True)
    total_fees_paid=models.DecimalField(max_digits=10, decimal_places=2, blank=True)
