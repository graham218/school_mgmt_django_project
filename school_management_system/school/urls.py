...
urlpatterns = [
    ...
    path('update_student_profile/', views.UpdateStudent, name='update_student_profile'),
    ...
    path('update_lecturer_profile/', views.UpdateLecturer, name='update_lecturer_profile'),
